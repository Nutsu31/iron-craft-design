...
checkout1.addEventListener("click", (e) => {
  e.preventDefault();
  document.getElementById("changeModels").src = "./img/models/gates/gate1.png";
  document.getElementById("doorNumber").innerHTML = "Gate #N601";
...
checkout2.addEventListener("click", (e) => {
  ...
  document.getElementById("doorNumber").innerHTML = "Gate #N602";
  openable.style.display = "flex";
  openable.style.position = "fixed";
  photo1.style.display = "block";
  openable.style.transform = `translate(${0}%)`;
...
checkout3.addEventListener("click", (e) => {
  ...
  document.getElementById("doorNumber").innerHTML = "Gate #N603";
  openable.style.display = "flex";
  openable.style.position = "fixed";
  photo1.style.display = "block";
  openable.style.transform = `translate(${0}%)`;
...
checkout4.addEventListener("click", (e) => {
  ...
  document.getElementById("doorNumber").innerHTML = "Gate #N604";
  openable.style.display = "flex";
  openable.style.position = "fixed";
  photo1.style.display = "block";
  openable.style.transform = `translate(${0}%)`;
...
checkout5.addEventListener("click", (e) => {
  ...
  document.getElementById("doorNumber").innerHTML = "Gate #N605";
  openable.style.display = "flex";
  openable.style.position = "fixed";
  photo1.style.display = "block";
  openable.style.transform = `translate(${0}%)`;
...
checkout6.addEventListener("click", (e) => {
  ...
  document.getElementById("doorNumber").innerHTML = "Gate #N606";
  openable.style.display = "flex";
  openable.style.position = "fixed";
  photo1.style.display = "block";
  openable.style.transform = `translate(${0}%)`;
...
checkout7.addEventListener("click", (e) => {
  ...
  document.getElementById("doorNumber").innerHTML = "Gate #N607";
  openable.style.display = "flex";
  openable.style.position = "fixed";
  photo1.style.display = "block";
  openable.style.transform = `translate(${0}%)`;
...
checkout8.addEventListener("click", (e) => {
  ...
  document.getElementById("doorNumber").innerHTML = "Gate #N608";
  openable.style.display = "flex";
  openable.style.position = "fixed";
  photo1.style.display = "block";
  openable.style.transform = `translate(${0}%)`;
